...
function cargarProd(){
  ...
  $result = $objConsultas->ConsultarProd();
   ...
   if(!isset($result)){
      ...
      <a href="../../Controllers/Vendedor/eliminarProd.php?producto_codigo='.$f['producto_codigo'].'" class="btn btn-primary ">Eliminar</a>
      </td>
        </tr>';
      }
  }
...
function cargarVent(){
  ...
  if(!isset($result)){
      ...
      <a href="../../Controllers/Vendedor/eliminarVent.php?venta_id='.$f['venta_id'].'" class="btn btn-primary ">Eliminar</a>
      </td>
        </tr>';
      }
  }
...
function cargarCatF(){
  ...
  if(!isset($result)){
      ...
      <a href="../../Controllers/Vendedor/eliminarCat.php?categoria_id='.$f['categoria_id'].'" class="btn btn-primary ">Eliminar</a>
      </td>
        </tr>';
      }
  }
...
function cargarUserEdit(){
    ...
    foreach($result as $f){
        echo '
        <form class="row g-3 needs-validation" method="post" action="../../Controllers/Vendedor/editarUser.php" enctype="multipart/form-data">
...
function cargarProdEdit(){
  ...
  foreach($result as $f){
      echo '
      <form class="row g-3 needs-validation" method="post" action="../../Controllers/Vendedor/editarProd.php" enctype="multipart/form-data">
...
function cargarCatEdit(){
  ...
  foreach($result as $f){
      echo '
      <form class="row g-3 needs-validation" method="post" action="../../Controllers/Vendedor/editarCat.php" enctype="multipart/form-data">
...
function cargarVentEdit(){
  ...
  foreach($result as $f){
      echo '
      <form class="row g-3 needs-validation" method="post" action="../../Controllers/Vendedor/editarVent.php" enctype="multipart/form-data">
